...
func TestInfiniteHashLimitedPriorityHashListChannelWriteReadLen(t *testing.T) {
	testDefaultInfiniteChannelWriteReadLen(infinitechannel.NewInfiniteHashLimitedPriorityHashListChannel(), 1000, func(index int) int { return index }, t)
}
...
func TestInfiniteHashLimitedPriorityHashListChannelConcurrentWriteReadLen(t *testing.T) {
	result := func(index int) int { return index }
	testDefaultInfiniteChannelConcurrentWriteReadLen(infinitechannel.NewInfiniteHashLimitedPriorityHashListChannel(), 1000, &result, t)
}
